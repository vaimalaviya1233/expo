...
export function SelectCard({
  ...
  return (
    <ButtonBase onClick={onClick}>
      <div className="w-[250px] shadow-xs overflow-hidden rounded-lg flex flex-col items-center border border-default hocus:scale-[102%] transition-all hocus:shadow-sm">
        <div
